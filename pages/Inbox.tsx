...
const mockMessages: Message[] = [
  ...
  { id: '4', sender: 'Linda Groenewald', avatar: 'https://picsum.photos/seed/linda-g/40/40', content: 'Quick one — can we move our strategy session to 3 PM Thursday? Also, the Vantage Advisory onboarding doc is ready for your review.', time: 'Yesterday', channel: Channel.WHATSAPP, unread: false, status: 'HUMAN_HANDOVER' },
