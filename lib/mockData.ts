...
export const MOCK_ACTIVITY_FEED: ActivityFeedItem[] = [
  ...
  { id: 'af-4', company: 'Vantage Advisory', action: 'reposted your thought leadership piece', timeAgo: '32 minutes ago', credits: 15, avatarSeed: 14 },
  ...
  { id: 'af-7', company: 'Vantage Advisory', action: 'liked your post "The Death of Cold Outreach"', timeAgo: 'Just now', credits: 1, avatarSeed: 14 },
